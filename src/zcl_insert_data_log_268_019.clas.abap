CLASS zcl_insert_data_log_268_019 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_insert_data_log_268_019 IMPLEMENTATION.
...
**    INTO CORRESPONDING FIELDS OF TABLE @lt_book_sup.
    ...
    DELETE FROM: ztravel_268_19,
                 zbooking_log_19,
                 zbooksuppl_log19.

    INSERT: ztravel_268_19   FROM TABLE @lt_travel,
            zbooking_log_19  FROM TABLE @lt_booking,
            zbooksuppl_log19 FROM TABLE @lt_book_sup.
